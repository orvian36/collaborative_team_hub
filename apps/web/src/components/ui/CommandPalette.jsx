    ...
    >
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <Command.List className="max-h-80 overflow-y-auto p-2">
          ...
          <Command.Group heading="Navigate" className="text-xs font-semibold text-gray-500 px-3 py-2 uppercase tracking-wider">
          ...
          <Command.Group heading="Create" className="text-xs font-semibold text-gray-500 px-3 py-2 uppercase tracking-wider mt-2">
          ...
          <Command.Group heading="Actions" className="text-xs font-semibold text-gray-500 px-3 py-2 uppercase tracking-wider mt-2">
